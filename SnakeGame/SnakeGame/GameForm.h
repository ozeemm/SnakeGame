...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->CoordText->Font = (gcnew System::Drawing::Font(L"DS Pixel Cyr", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->CoordText->Location = System::Drawing::Point(692, 47);
			this->CoordText->Name = L"CoordText";
			this->CoordText->Size = System::Drawing::Size(64, 24);
...
#pragma endregion
		...
		private: PictureBox^ wall; // Один элемент стенки
